...
var Admin, Conference, Config, Organisation, Schema, Slide, confDB, dsn, getOrgaList, mongoose, readConference, readSlideList, readSlideListForSlider, readSlideToSend, setSent,
  _this = this;
...
module.exports.getOrgaListfromAdmin = getOrgaList = function(AdminEmail, callback) {
  var organisation;
